...
import { houseIdValidation, messageIdValidation, messageStatusValidation, sendMessageValidation } from "../zodValidation/messages";
...
export const getHouseMessages = asyncHandler(async(req:Request, res:Response)=>{
